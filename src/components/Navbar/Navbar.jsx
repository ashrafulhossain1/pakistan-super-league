...
const Navbar = ({balance}) => {
    return (
        <div className='sticky top-0 backdrop-blur-3xl z-40'>
            <div className="w-11/12 md:w-10/12 mx-auto flex flex-col md:flex-row justify-between items-center mt-2 md:mt-4 gap-y-2 md:gap-y-4">
            ...
            <div className='flex flex-col md:flex-row items-center gap-4 text-xs md:text-base '>
                <ul className="flex gap-4 items-center font-medium text-gray-500">
