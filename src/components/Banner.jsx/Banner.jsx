    ...
    return (
        <div
            ...
            <div
                ...
                <p className='text-sm md:text-xl xl:text-2xl'>Beyond Boundaries Beyond Limits</p>
                <div className='p-0.5 border rounded-2xl border-lime-500'>
                    <button onClick={handleFreeClaim} className="border-none text-sm p-3 md:p-4 md:text-base text-black bg-lime-400 hover:bg-lime-500 font-semibold rounded-[14px]">
                        Claim Free Credit
                    </button>
                </div>
            </div>
...
Banner.propTypes = {
    handleFreeClaim:PropTypes.func.isRequired
}
