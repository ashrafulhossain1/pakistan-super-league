        ...
        <div
            ...
            <div
                ...
                <div className='p-0.5 border rounded-2xl border-lime-500'>
                    <button onClick={handleFreeClaim} className="border-none text-sm p-2 md:p-4 md:text-base text-black bg-lime-400 hover:bg-lime-500 font-semibold rounded-[14px]">
                        Claim Free Credit
                    </button>
                </div>
            </div>
